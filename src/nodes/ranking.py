...
from src.tools.embeddings import EmbeddingClient, compute_novelty_score
    ...
    *,
    ...
    for v in variants:
        ...
        if pattern_name not in pattern_scores:
            ...
            pattern_scores[pattern_name] = perf.effectiveness_score
    ...
    for i, v in enumerate(variants):
        ...
        novelty = await compute_novelty_score(
            v.get("content", ""), recent_contents, embedding_client
        )
